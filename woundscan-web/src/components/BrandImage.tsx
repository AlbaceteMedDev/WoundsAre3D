...
type Variant = "lockup" | "wordmark" | "symbol" | "mark";
 ...
 * symbol (SM mark, transparent) ~407×378; square mark (favicon) 1254×1254.
 */
const ASSETS: Record<Variant, { light: string; dark: string; w: number; h: number }> = {
  ...
  symbol: { light: "/symbol-light.png", dark: "/symbol-dark.png", w: 407, h: 378 },
  mark: { light: "/icon-light.png", dark: "/icon-dark.png", w: 1254, h: 1254 },
};

type Props = {
  /** "lockup" = full lockup; "wordmark" = "StrataMetric"; "symbol" = SM mark; "mark" = square favicon badge. */
  variant: Variant;
